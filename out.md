...
assessments from ages 10 to 19). The Level 1 model estimated

depressive severity across the ten time-points (e.g., annual

### participants decreased an average of 0.51 unit in
